import { OnExtensionSubscriber, OnNextSubscriber, OnTerminalSubscriber, Payload } from "@rsocket/core";

export default class BufferingForwardingSubscriber<T> implements OnNextSubscriber, OnTerminalSubscriber, OnExtensionSubscriber {
  private subscriber: OnNextSubscriber & OnTerminalSubscriber & OnExtensionSubscriber;
  ...
  subscribe(subscriber: OnNextSubscriber & OnTerminalSubscriber & OnExtensionSubscriber): void {
